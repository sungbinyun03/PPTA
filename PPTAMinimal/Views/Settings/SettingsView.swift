...
/// Destructive "Delete Account" row. Deletion itself (Firestore cascade + Auth record) runs
/// server-side via the `deleteAccount` Cloud Run function — see `AuthViewModel.deleteAccount()`.
